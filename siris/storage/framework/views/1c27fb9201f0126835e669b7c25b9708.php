<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="<?php echo e(route('dashboard')); ?>">SIRIS</a>
            </div>
...
>>>>>>> origin/JoseV2:siris/resources/views/layouts/sidebar.blade.php
            ...
            <li
                ...
                <ul class="submenu ">                    
                    <li class="submenu-item  ">
                        <a href="<?php echo e(route('informe.periodo')); ?>" class="submenu-link">Periodo informado</a>                        
                    </li>                    
                    <li class="submenu-item  ">
                        <a href="<?php echo e(route('informe.ente-publico')); ?>" class="submenu-link">Entes públicos</a>                        
                    </li>                    
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="submenu ">
                    <li class="submenu-item  ">
                        <a href="<?php echo e(route('sancionados.sancionados')); ?>" class="submenu-link">Reportes</a>   
                    </li>
                </ul>                
            </li>
            ...
            <li
                ...
                <ul class="submenu ">                    
                    <li class="submenu-item  ">
                        <a href="layout-default.html" class="submenu-link">Periodo informe</a>
...
<?php /**PATH C:\xampp\htdocs\SirisLaravel-main\siris\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>