    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle" id="tablaSancionados" style="font-size: 0.9rem; color: #333;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>2</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-02/2026</a></td>
                        <td class="text-dark">LAURA SANSORES PEÑA</td>
                        <td>SABGOB</td>
                        <td class="text-center"><span class="badge bg-light-warning text-warning text-dark px-3">NEPOTISMO</span></td>
                        <td>ECONÓMICA</td>
                        <td>PERSONA MORAL</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-03/2026</a></td>
                    ...
                    <tr>
                        <td>4</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-04/2026</a></td>
                        <td class="text-dark">FERNANDA CAMACHO JACINTO</td>
                        <td>SABGOB</td>
                        <td class="text-center"><span class="badge bg-light-warning text-warning text-dark px-3">NEPOTISMO</span></td>
                        <td>ECONÓMICA</td>
                        <td>PERSONA MORAL</td>
                    ...
                    <tr>
                        ...
                        <td class="text-dark">JAVIER ARTURO RANGEL AVELAR</td>
                        <td>SABGOB</td>
                        <td class="text-center"><span class="badge bg-light-danger text-danger px-3">PECULADO</span></td>
                        <td>INHABILITACIÓN, ECONÓMICA</td>
                        <td>PERSONA FÍSICA</td>
                    ...
                    <tr>
                        <td>6</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-06/2026</a></td>
                        <td class="text-dark">ISAI MISAEL MAGAÑA TUZ</td>
                        <td>SESA</td>
                        <td class="text-center"><span class="badge bg-light-warning text-warning text-dark px-3">NEPOTISMO</span></td>
                        <td>INHABILITACIÓN, ECONÓMICA</td>
                        <td>PERSONA FÍSICA</td>
                    ...
                    <tr>
                        <td>7</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-07/2026</a></td>
                        <td class="text-dark">MADOX QUE FAJARDO</td>
                        <td>SEDETUR</td>
                        <td class="text-center"><span class="badge bg-light-danger text-danger px-3">PECULADO</span></td>
                        <td>INHABILITACIÓN, ECONÓMICA</td>
                        <td>PERSONA FÍSICA</td>
                    ...
                    <tr>
                        <td>8</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-08/2026</a></td>
                        <td class="text-dark">ARIEL RIVERO MOO</td>
                        <td>SESA</td>
                        <td class="text-center"><span class="badge bg-light-warning text-warning text-dark px-3">NEPOTISMO</span></td>
                        <td>ECONÓMICA</td>
                        <td>PERSONA MORAL</td>
                    ...
                    <tr>
                        <td>9</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-09/2026</a></td>
                        <td class="text-dark">RICARDO MANZANILLA POOT</td>
                        <td>CAPA</td>
                        <td class="text-center"><span class="badge bg-light-danger text-danger px-3">PECULADO</span></td>
                    ...
                    <tr>
                        <td>10</td>
                        <td><a href="#" class="text-decoration-none fw-bold" style="color: #4f5fbd;">SP-10/2026</a></td>
                        <td class="text-dark">SOFIA LARA VALENCIA</td>
                        <td>SEFIPLAN</td>
                        <td class="text-center"><span class="badge bg-light-warning text-warning text-dark px-3">COHECHO</span></td>
                        <td>ECONÓMICA</td>
                        <td>PERSONA FÍSICA</td>
                    </tr>
                </tbody>
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 p-3 bg-dark text-white rounded-3 shadow-sm">
            <p class="mb-0 small" id="infoRegistros">
                <i class="bi bi-info-circle me-2"></i> Mostrando 10 registros filtrados
            </p>
...
<style>
    ...
    .bg-light-warning { background-color: #fff3cd; color: #856404; }
</style>
