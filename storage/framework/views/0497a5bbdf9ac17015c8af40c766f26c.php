<div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
        ...
        <li class="sidebar-item active">
            ...
            <li
                class="sidebar-item">
                <a href="/panel_informativo" class='sidebar-link'>
            ...
            <li
                ...
                <ul class="submenu ">                    
                    <li class="submenu-item  ">
                        <a href="/informeQuincenal/enlace" class="submenu-link">Periodo informado</a>                        
                    </li>                    
                    <li class="submenu-item  ">
                        <a href="/informe/entepublico" class="submenu-link">Entes públicos</a>                        
                    </li>                    
                </ul>
            </li>
...
</div><?php /**PATH C:\Users\josec\Desktop\siris\siris\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>