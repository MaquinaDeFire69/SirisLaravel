        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card shadow h-100 border-start border-warning border-4">
                    <div class="card-body text-center d-flex flex-column justify-content-between">
                        <p class="card-text text-dark mb-2 fs-5">Avance de cumplimiento</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="text-center mb-4">
                        <h5 class="fw-bold text-dark">Listado de entes públicos proveedores de información con</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td><td>SABGOB</td><td>2026-16-01</td>
                                    <td><span class="badge bg-success">Normal</span></td>
                                </tr>
                                <tr>
                                    <td>24</td><td>SEDE</td><td>2026-22-01</td>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josec\Desktop\siris\siris\resources\views/panel_informativo/panelInformativo.blade.php ENDPATH**/ ?>