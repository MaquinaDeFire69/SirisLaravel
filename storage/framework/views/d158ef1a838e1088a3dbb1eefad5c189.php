    ...
    <div class="page-content text-dark">
        ...
        <div id="contenedor-principal">
            ...
            <div id="seccion-tablas" class="d-none">
                ...
                <?php $categorias = ['Servidores públicos', 'Personas Físicas', 'Personas Morales']; ?>
                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white py-2">
                        <h5 class="card-title text-white mb-0"><?php echo e($cat); ?></h5>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josec\Desktop\siris\siris\resources\views/informeQuincenal/informeEnlace.blade.php ENDPATH**/ ?>